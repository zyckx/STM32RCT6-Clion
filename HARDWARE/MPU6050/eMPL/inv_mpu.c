 ...
 *                  MPU9250 (or MPU6050 w/ AK8963 on the auxiliary bus)
 */
#include <stdio.h>
#include <stdint.h>
#include <stdlib.h>
...
#define MPU6500_MEM_REV_ADDR    (0x17)
    ...
    /* MPU6050 shares 4kB of memory between the DMP and the FIFO. Since the
 ...
 *  \n MPU6050: 1.25Hz, 2.5Hz, 5Hz, 10Hz, 20Hz, 40Hz, 80Hz, 160Hz, 320Hz, 640Hz
 ...
 *  \n Bit 2:   Compass.
 *
 *  \n Currently, the hardware self-test is unsupported for MPU6050. However,
 ...
 *  MPU6050. Each chip's version of this feature is explained below.
 *
 *  \n MPU6050:
 ...
 *  increments.
 *
 *  \n MPU6050 Low-power accel mode supports the following frequencies:
 ...
 *  \n To select a fractional wake-up frequency, round down the value passed to
 *  @e lpa_freq.
 *  \n The MPU6050 does not support a delay parameter. If this function is used
 *  for the MPU6050, the value passed to @e time will be ignored.
    ...
    unsigned char lpa_freq)
{
    ...
    if (lpa_freq) {
        ...
        /* Enable motion interrupt (MPU6050 version). */
        data[0] = BITS_WOM_EN;
...
#ifdef MPU6500
    /* Disable motion interrupt (MPU6050 version). */
    data[0] = 0;
    if (i2c_write(st.hw->addr, st.reg->accel_intel, 1, data))
        goto lp_int_restore;
#endif
